...
|------|------------|---------|
| `r-coding-standards.instructions.md` | `**/*.R` | R code style, naming, documentation |
| `testing.instructions.md` | `tests/**/*` | Test patterns, modes, helpers |
...
1. **Keep the same structure and format** - All files follow the template
