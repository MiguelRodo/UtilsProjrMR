...
To assist with project set-up, including configuring `.Rprofile` for development and installing useful packages:
...
The package provides several `projr_cat_*` functions that print out commonly-used code snippets:
